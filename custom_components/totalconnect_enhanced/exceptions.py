...
class AutomationDeviceError(TotalConnectError):
    """Base class for automation device errors."""


class AutomationDeviceNotFound(AutomationDeviceError):
    """The automation device was not found or is not accessible."""


class AutomationDeviceOffline(AutomationDeviceError):
    """The automation device is offline or not responding."""


class AutomationDeviceControlFailed(AutomationDeviceError):
    """Failed to control the automation device."""
