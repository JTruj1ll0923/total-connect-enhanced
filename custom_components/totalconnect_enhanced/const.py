...
class ArmingState(Enum):
    ...
    def is_triggered(self) -> bool:
        ...
        return self.is_triggered_fire() or self.is_triggered_gas() or self.is_triggered_police()
...
class _ResultCode(Enum):
    ...
    def from_response(response_dict: dict[str, Any]) -> "_ResultCode":
        ...
        try:
            ...
            raise BadResultCodeError(f"unknown result code {value}", response_dict) from None
    ...
    # Automation device error codes
    AUTOMATION_DEVICE_NOT_FOUND = -4002
    AUTOMATION_DEVICE_OFFLINE = -4004
...
# Automation device endpoints
HTTP_API_AUTOMATION_DEVICE_STATUS: Final = make_http_endpoint(
    "/automation/GetAutomationDeviceStatus"
)
HTTP_API_AUTOMATION_DEVICE_STATUS_EX: Final = make_http_endpoint(
    "/automation/GetAutomationDeviceStatusExV1"
)
HTTP_API_ALL_AUTOMATION_DEVICE_STATUS: Final = make_http_endpoint(
    "/automation/GetAllAutomationDeviceStatusExV1"
)
HTTP_API_DEVICE_STATUS: Final = make_http_endpoint("/automation/GetDeviceStatus")
HTTP_API_DEVICE_CONTROL: Final = make_http_endpoint("/automation/DeviceControl")

# Garage door endpoints
HTTP_API_GARAGE_DOORS: Final = "/api/v1/locations/{location_id}/garageDoors"

# SOAP endpoints for device control
SOAP_URL: Final = "https://rs.alarmnet.com/TC21API/TC2.asmx"
SOAP_CONTROL_LOCK: Final = "https://services.alarmnet.com/TC2/ControlALock"
SOAP_CONTROL_SWITCH: Final = "https://services.alarmnet.com/TC2/ControlASwitch"
